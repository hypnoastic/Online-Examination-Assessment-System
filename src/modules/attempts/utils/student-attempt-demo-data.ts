...
import { toBootstrapAttemptId } from "./attempt-identifiers";
    ...
    sessionTemplate: {
      ...
      questions: [
        ...
        },
        {
          ...
          reviewMode: "OBJECTIVE",
          stem: "Select statements that are valid properties of ACID transactions.",
          maxMarks: 3,
          options: [
            { id: "opt-dbms-2-a", label: "A", text: "Atomicity avoids partial commits." },
            { id: "opt-dbms-2-b", label: "B", text: "Durability means data can vanish after power loss." },
            { id: "opt-dbms-2-c", label: "C", text: "Isolation protects concurrent correctness." },
            { id: "opt-dbms-2-d", label: "D", text: "Consistency preserves valid state transitions." },
          ],
        },
        {
        ...
        {
          examQuestionId: "eq-dbms-4",
          questionId: "question-dbms-4",
          questionOrder: 4,
          type: "SHORT_TEXT",
          reviewMode: "MANUAL",
        ...
        {
          examQuestionId: "eq-dbms-5",
          questionId: "question-dbms-5",
          questionOrder: 5,
          type: "LONG_TEXT",
          reviewMode: "MANUAL",
          stem: "Describe how normalization tradeoffs affect reporting queries in a real academic system.",
          maxMarks: 8,
        },
      ],
    },
